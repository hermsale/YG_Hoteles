       ...
       <section class="bg-gray-900 text-white pt-32 pb-16">
           <div class="max-w-6xl mx-auto px-4">
               <div class="flex justify-between items-center mb-10">
                   ...
                   <a href="{{ route('backoffice.habitaciones.crear') }}"
                ...
                <div class="md:w-2/3">
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mt-4">
                        ...
                        <div class="mt-4 sm:mt-0 flex gap-2">
                            <a href="{{ route('backoffice.habitaciones.editar', $habitacion->id) }}"
                            ...
                            <form action="{{ route('backoffice.habitaciones.inhabilitar', $habitacion) }}" method="POST"
                            ...
                            @else
                            <form action="{{ route('backoffice.habitaciones.habilitar', $habitacion) }}" method="POST"
