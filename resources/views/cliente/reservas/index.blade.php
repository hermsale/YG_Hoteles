        ...
        <div class="relative mt-24 py-20 bg-white bg-opacity-90 rounded-md shadow-lg p-6 max-w-6xl mx-auto">
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full border border-gray-300 text-sm text-gray-900">
                    ...
                    <tbody>
                        <tr class="bg-white">
                            <td class="px-4 py-2 border">20 Abr. 2025</td>
                            <td class="px-4 py-2 border">Pagada</td>
                            <td class="px-4 py-2 border">01 - Deluxe</td>
                            <td class="px-4 py-2 border">15 Jul. 2025</td>
                            <td class="px-4 py-2 border">22 Jul. 2025</td>
                            <td class="px-4 py-2 border">630,000 ARS</td>
                            <td class="px-4 py-2 border text-blue-600 hover:underline cursor-pointer">
                                <a href="{{ url('/reserva/1') }}" class="text-blue-600 hover:underline">
                                    Ver detalles
                                </a>
                            </td>
                        </tr>
                        <tr class="bg-white">
                            <td class="px-4 py-2 border">20 Abr. 2025</td>
                            <td class="px-4 py-2 border">Pendiente</td>
                            <td class="px-4 py-2 border">02 - Estándar</td>
                            <td class="px-4 py-2 border">30 Dic. 2025</td>
                            <td class="px-4 py-2 border">4 Ene. 2026</td>
                            <td class="px-4 py-2 border">360,000 ARS</td>
                            <td class="px-4 py-2 border text-blue-600 hover:underline cursor-pointer">
                                <a href="{{ url('/reserva/1') }}" class="text-blue-600 hover:underline">
                                    Ver detalles
                                </a>
